...
static const float CITY_LIGHTS_BLOOM_FACTOR 	= 2.5;
...
static const float 	SNOW_OPACITY_MIN			= 2.0f;
static const float 	SNOW_OPACITY_MAX			= 0.02f;
static const float 	SNOW_CAM_MIN 				= 50.0f;
static const float 	SNOW_CAM_MAX 				= 300.0f;
static const float 	ICE_CAM_MIN 				= 50.0f;
static const float 	ICE_CAM_MAX 				= 300.0f;
...
static const float GB_THRESHOLD = 0.01f;
static const float GB_THRESHOLD2 = 0.15f;
static const float GB_OUTLINE_CUTOFF_SEA = 0.988f; 
...
static const float BORDER_FOW_REMOVAL_FACTOR = 1.0;
static const float BORDER_LIGHT_REMOVAL_FACTOR = 0.8;
static const float GB_STRENGTH_CH1 = 1.0;
static const float GB_STRENGTH_CH2 = 0.1;
